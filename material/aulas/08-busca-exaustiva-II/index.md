...
!!! example
    ...
    * você pode usar `os.system`, mas `subprocess.run` permite colocar um tempo limite de execução. Isto pode ser muito conveniente dependendo do tipo de pergunta que formulou
    * `time.time()` pode ser interessante para medir o tempo de execução do seu programa. 
